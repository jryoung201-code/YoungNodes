// engine.js — executes the node graph and drives the stage sprite
...
class Engine {
  constructor(graph, stageCanvas, logFn, statusFn) {
    this.graph = graph;       // reference to Graph instance
  ...
  // Resolve a data input: check wire first, then fall back to node field
